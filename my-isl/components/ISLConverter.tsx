        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            <Button
              variant="ghost"
              className="text-white hover:text-indigo-200"
              onClick={() => setActiveTab("audio-to-isl")}
            >
            ...
            <Button
              variant="ghost"
              className="text-white hover:text-indigo-200"
              onClick={() => setActiveTab("text-to-isl")}
            >
            ...
            <Button
              variant="ghost"
              className="text-white hover:text-indigo-200"
              onClick={() => setActiveTab("isl-to-text")}
            >
        ...
        <Card className="w-full bg-white bg-opacity-90 backdrop-blur-lg shadow-xl">
          <CardHeader>
            ...
            <CardDescription className="text-center text-indigo-600">
              Bridging communication gaps with cutting-edge technology
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs
            ...
            >
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <p className="text-lg text-gray-700 mb-8">
                      Empowering communication through innovative sign language
                      technology
                    </p>
                  </div>
                  <div className="grid md:grid-cols-2 gap-8">
                    <Card className="bg-gradient-to-br from-blue-100 to-indigo-100 hover:shadow-lg transition-shadow duration-300">
                      ...
                      <CardContent>
                        <p className="text-gray-700">
                          Convert spoken words into Indian Sign Language
                    ...
                    <Card className="bg-gradient-to-br from-purple-100 to-pink-100 hover:shadow-lg transition-shadow duration-300">
                      ...
                      <CardContent>
                        <p className="text-gray-700">
                          Transform written text into clear and accurate Indian
                    ...
                    <Card className="bg-gradient-to-br from-green-100 to-teal-100 hover:shadow-lg transition-shadow duration-300">
                      ...
                      <CardContent>
                        <p className="text-gray-700">
                          Interpret Indian Sign Language and convert it into
                          written text with multiple language options.
                        </p>
                      </CardContent>
                      <CardFooter>
                        <Button
                    ...
                    <Card className="bg-gradient-to-br from-yellow-100 to-orange-100 hover:shadow-lg transition-shadow duration-300">
                      ...
                      <CardContent>
                        <p className="text-gray-700">
                          Interactive lessons and games to help children and
                          adults learn Indian Sign Language.
                        </p>
                      </CardContent>
                      <CardFooter>
                        <Button
              ...
              <TabsContent value="audio-to-isl">
                <div className="space-y-4">
                  ...
                  <Button
                    onClick={() => handleConvert("audio-to-isl")}
                    className="w-full bg-indigo-600 hover:bg-indigo-700 text-white"
                  >
                    Convert
                  </Button>
              ...
              <TabsContent value="text-to-isl">
                <div className="space-y-4">
                  ...
                  <Textarea
                    placeholder="Enter text to convert to ISL"
                  ...
                  <Button
                    onClick={() => handleConvert("text-to-isl")}
                    className="w-full bg-indigo-600 hover:bg-indigo-700 text-white"
                  >
                    Convert
                  </Button>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex space-x-2">
                    ...
                    >
                      ...
                      >
                        <SelectItem value="english" style={{ color: "white" }}>
                          English
                        </SelectItem>
                        <SelectItem value="hindi" style={{ color: "white" }}>
                          Hindi
                        </SelectItem>
                        <SelectItem value="bengali" style={{ color: "white" }}>
                          Bengali
                        </SelectItem>
                        <SelectItem value="marathi" style={{ color: "white" }}>
                          Marathi
                        </SelectItem>
                        <SelectItem value="tamil" style={{ color: "white" }}>
                          Tamil
                        </SelectItem>
                        <SelectItem value="gujrati" style={{ color: "white" }}>
                          Gujrati
                        </SelectItem>
                        <SelectItem value="bhojpuri" style={{ color: "white" }}>
                          Bhojpuri
                        </SelectItem>
                        <SelectItem value="maithili" style={{ color: "white" }}>
                          Maithili
                        </SelectItem>
                        <SelectItem value="oriya" style={{ color: "white" }}>
                          Oriya
                        </SelectItem>
                      </SelectContent>
                    </Select>
                    <Button
                      onClick={() => handleConvert("isl-to-text")}
                  ...
                  <Textarea
                    placeholder="Converted and translated text will appear here"
                    className="w-full p-2 border border-indigo-300 rounded-md focus:ring-2 focus:ring-indigo-500"
                    readOnly
                  />
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    <Card className="bg-gradient-to-br from-green-100 to-teal-100 hover:shadow-lg transition-shadow duration-300">
                      ...
                      <CardContent>
                        <p className="text-gray-700">
                          Learn common signs for everyday objects and actions.
                        </p>
                      </CardContent>
                      <CardFooter>
                        <Button className="w-full bg-indigo-600 hover:bg-indigo-700 text-white">
                    ...
                    <Card className="bg-gradient-to-br from-yellow-100 to-orange-100 hover:shadow-lg transition-shadow duration-300">
                      ...
                      <CardContent>
                        <p className="text-gray-700">
                          Play interactive games to practice ISL in a fun way.
                        </p>
                      </CardContent>
                      <CardFooter>
                        <Button className="w-full bg-indigo-600 hover:bg-indigo-700 text-white">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <Card className="bg-gradient-to-br from-blue-100 to-indigo-100 hover:shadow-lg transition-shadow duration-300">
                        ...
                        <CardContent>
                          <p className="text-gray-700">
                            You have learned 50 signs this week!
                          </p>
                      ...
                      <Card className="bg-gradient-to-br from-purple-100 to-pink-100 hover:shadow-lg transition-shadow duration-300">
                        ...
                        <CardContent>
                          <p className="text-gray-700">
                            You have made 20 conversions this month.
                          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-sm">
                Our mission is to break communication barriers and promote
